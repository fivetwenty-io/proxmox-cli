...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -path /cluster/sdn/vnets/{vnet}/firewall/options -symbol vnetFirewallOptionSchemas -out vnet_firewall_options_schema_gen.go

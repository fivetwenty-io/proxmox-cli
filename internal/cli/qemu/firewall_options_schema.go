...
//go:generate go run github.com/fivetwenty-io/pmx-cli/cmd/optionsgen -path /nodes/{node}/qemu/{vmid}/firewall/options -symbol firewallOptionSchemas -out firewall_options_schema_gen.go

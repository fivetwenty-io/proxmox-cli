...
//go:generate go run github.com/fivetwenty-io/proxmox-cli/cmd/optionsgen -path /nodes/{node}/firewall/options -symbol firewallOptionSchemas -out firewall_options_schema_gen.go

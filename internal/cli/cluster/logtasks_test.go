...
// TestClusterLog_Table verifies that `pmx pve cluster log` queries GET /cluster/log,
...
// TestClusterTasks_Table verifies `pmx pve cluster tasks` queries GET /cluster/tasks

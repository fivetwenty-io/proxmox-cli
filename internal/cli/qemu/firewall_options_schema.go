...
//go:generate go run github.com/fivetwenty-io/proxmox-cli/cmd/optionsgen -path /nodes/{node}/qemu/{vmid}/firewall/options -symbol firewallOptionSchemas -out firewall_options_schema_gen.go

...
// newClusterBackupInfoCmd builds the `pve cluster backup-info` sub-tree for backup
...
// newBackupInfoNotBackedUpCmd builds `pve cluster backup-info not-backed-up`.

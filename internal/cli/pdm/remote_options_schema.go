...
//go:generate go run github.com/fivetwenty-io/pmx-cli/cmd/optionsgen -source pdm-apidoc.json -path /remotes/remote -verb POST -symbol remoteOptionSchemas -exclude "id,token" -out remote_options_schema_gen.go

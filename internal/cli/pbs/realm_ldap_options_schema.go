...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/access/ldap -verb POST -symbol realmLdapOptionSchemas -exclude "realm,password" -out realm_ldap_options_schema_gen.go

...
//go:generate go run github.com/fivetwenty-io/proxmox-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/notifications/endpoints/sendmail -verb POST -symbol notifSendmailOptionSchemas -exclude "name" -out notification_endpoint_sendmail_options_schema_gen.go

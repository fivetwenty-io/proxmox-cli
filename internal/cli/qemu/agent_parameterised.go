...
// newAgentExecCmd builds `pmx pve qemu agent exec <vmid> [-- <cmd>...]`.
...
// newAgentExecStatusCmd builds `pmx pve qemu agent exec-status <vmid> --pid PID`.
...
// newAgentFileReadCmd builds `pmx pve qemu agent file-read <vmid> --file PATH [--offset N] [--count N]`.
...
// newAgentFileWriteCmd builds `pmx pve qemu agent file-write <vmid> --file PATH --content CONTENT`.
...
// newAgentSetUserPasswordCmd builds `pmx pve qemu agent set-user-password <vmid> --username USER`.

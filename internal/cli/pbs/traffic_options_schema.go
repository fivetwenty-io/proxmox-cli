...
//go:generate go run github.com/fivetwenty-io/proxmox-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/traffic-control -verb POST -symbol trafficOptionSchemas -exclude "name" -out traffic_options_schema_gen.go

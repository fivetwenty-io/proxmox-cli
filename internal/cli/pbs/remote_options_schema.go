...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/remote -verb POST -symbol remoteOptionSchemas -exclude "name,password" -out remote_options_schema_gen.go

...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/access/ad -verb POST -symbol realmAdOptionSchemas -exclude "realm,password" -out realm_ad_options_schema_gen.go

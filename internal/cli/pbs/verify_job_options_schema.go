...
//go:generate go run github.com/fivetwenty-io/pmx-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/verify -verb POST -symbol verifyJobOptionSchemas -exclude "id" -out verify_job_options_schema_gen.go

...
def run(ctx: Ctx) -> None:
    ...
    ctx.defer(
        ...
        "pmx cluster backup create --id pmxcli-backup --schedule 'sun 03:30' --pool pmx-cli ...",
    ...
    ctx.defer(
        ...
        "pmx cluster ha resource create vm:<id> --state started ... && ... delete vm:<id> --yes",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster ha resource migrate vm:<id> --target-node <other>",
    ...
    ctx.defer(
        ...
        "pmx cluster ha resource relocate vm:<id> --target-node <other>",
        isolation=True, live_covered=False,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster ha rule create pmx-cli-rule --type node-affinity --resources vm:<id> --nodes <node>",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster firewall group create pmxcli-grp && pmx cluster firewall ipset add pmxcli-clips 172.30.0.0/24",
        isolation=True, live_covered=True,
    )
    ctx.defer(
        ...
        "pmx cluster firewall options set --enable 0",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster config create --clustername pmx-cli-test --yes",
        isolation=False, live_covered=False,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster options set --description 'pmx-cli-e2e ...'",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster replication create --id <guest>-0 --target-node <other> --schedule '*/15'",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster metrics server create pmx-cli-graphite --type graphite --server 172.30.0.250 --port 2003 --disable",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster notifications gotify create pmx-cli-gotify --server https://172.30.0.250 --token <dummy> --disable",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster jobs realm-sync create sync-ldap --schedule daily --realm pmx-cli-realm",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster acme plugin create pmx-cli-acme --type dns --api cf --data <dummy>",
        isolation=True, live_covered=True,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster acme account create --contact admin@example.com --directory <staging>",
        isolation=False, live_covered=False,
    )
    ctx.defer(
        "acme account set",
        ...
        "rejects API-token auth; not exercisable by the e2e suite — covered by unit tests",
        "pmx cluster acme account set <name> --contact admin@example.com",
        isolation=False, live_covered=False,
    )
    ctx.defer(
        "acme account delete",
        ...
        "rejects API-token auth; not exercisable by the e2e suite — covered by unit tests",
        "pmx cluster acme account delete <name> --yes",
        isolation=False, live_covered=False,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster ceph flags set noout true",
        isolation=False, live_covered=False,
    )
    ctx.defer(
        "ceph flags set-all",
        ...
        "pmx cluster ceph flags set-all --noout=true --norebalance=true",
        isolation=False, live_covered=False,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster bulk start --vmids <vmid> --yes",
        isolation=True, live_covered=True,
    )
    ctx.defer(
        "bulk shutdown",
        ...
        "pmx cluster bulk shutdown --vmids <vmid> --yes",
        isolation=True, live_covered=True,
    )
    ctx.defer(
        "bulk suspend",
        ...
        "pmx cluster bulk suspend --vmids <vmid> --yes",
        isolation=True, live_covered=True,
    )
    ctx.defer(
        "bulk migrate",
        ...
        "pmx cluster bulk migrate --target-node <node> --yes",
        isolation=False, live_covered=False,
    )
    ...
    ctx.defer(
        ...
        "pmx cluster cpu-model create pmx-cli-cpu --reported-model qemu64",
        isolation=True, live_covered=True,
    )

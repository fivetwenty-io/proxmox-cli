// Code generated by cmd/optionsgen from pdm-apidoc.json (github.com/fivetwenty-io/proxmox-apiclient-go/v3 POST /config/access/ldap); DO NOT EDIT.

package pdm

import "github.com/fivetwenty-io/pmx-cli/internal/optionschema"

// realmLdapOptionSchemas describes every settable option from the PVE API schema for
...
var realmLdapOptionSchemas = []optionschema.Schema{
	...
	},
	{
		...
		Type:        "string",
		Description: "Comma-separated list of key=value pairs for specifying which LDAP attributes map to which peat user field. For example, to map the LDAP attribute ``mail`` to peat's ``email``, write ``email=mail``.",
	},
	{

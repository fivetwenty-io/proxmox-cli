...
// TestAplinfoList_Success verifies `pmx pve storage aplinfo list` issues a GET to
...
// TestAplinfoDownload_Success verifies `pmx pve storage aplinfo download` issues a

// Code generated by cmd/optionsgen from apidoc.json (github.com/fivetwenty-io/proxmox-apiclient-go/v3 PUT /nodes/{node}/qemu/{vmid}/firewall/options); DO NOT EDIT.
...
// PUT /nodes/{node}/qemu/{vmid}/firewall/options, in lexical order by API key.

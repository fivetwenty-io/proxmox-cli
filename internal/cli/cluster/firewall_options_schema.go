...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -path /cluster/firewall/options -symbol firewallOptionSchemas -out firewall_options_schema_gen.go

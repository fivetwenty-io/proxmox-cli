...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/metrics/influxdb-udp -verb POST -symbol metricsInfluxdbUDPOptionSchemas -exclude "name" -out metrics_influxdb_udp_options_schema_gen.go

// Code generated by cmd/optionsgen from apidoc.json (github.com/fivetwenty-io/pve-apiclient-go/v3 PUT /cluster/sdn/vnets/{vnet}/firewall/options); DO NOT EDIT.

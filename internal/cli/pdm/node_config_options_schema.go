...
//go:generate go run github.com/fivetwenty-io/pmx-cli/cmd/optionsgen -source pdm-apidoc.json -path /nodes/{node}/config -verb PUT -symbol nodeConfigOptionSchemas -out node_config_options_schema_gen.go

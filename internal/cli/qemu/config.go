...
func newConfigSetCmd() *cobra.Command {
  ...
  pmx pve qemu config set 100 --set hugepages=1024`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			set("delete", func() { params.Delete = new(deleteKeys) })
			set("revert", func() { params.Revert = new(revertKeys) })
			set("digest", func() { params.Digest = new(digest) })
			...
			set("skiplock", func() { params.Skiplock = new(skiplock) })

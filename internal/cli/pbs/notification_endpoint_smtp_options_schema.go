...
//go:generate go run github.com/fivetwenty-io/pve-cli/cmd/optionsgen -source pbs-apidoc.json -path /config/notifications/endpoints/smtp -verb POST -symbol notifSmtpOptionSchemas -exclude "name,password" -out notification_endpoint_smtp_options_schema_gen.go
